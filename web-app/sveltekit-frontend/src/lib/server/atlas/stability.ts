import type { CandidateV1 } from './contracts';
 ...
 * delta = 1 - |A ∩ B| / |A ∪ B|
 *
 * A delta of zero means expansion did not change canonical membership. This is
 * an observed stabilization signal, not a proof that no unseen candidate exists.
 */
export function canonicalSetDelta(
