import type { AtlasRevisionSet, CandidateV1 } from './contracts';
 ...
 * fibers. Candidate.score is the local emission score. The caller supplies the
 * transition score so rename/move evidence, CHANGED_BY, AST continuity, call
 * neighborhood overlap, and revision ancestry remain evidence-driven rather
