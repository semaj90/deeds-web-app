import type { ResourceEnvelopeV1, ResourceUsageV1 } from './contracts';
...
/**
 * Reports which finite boundaries have been reached. A reached boundary is not
 * equivalent to a negative proof; callers should surface BOUNDARY_EXHAUSTED.
 */
